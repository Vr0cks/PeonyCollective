          ...
          <div className="pt-6 border-t border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <select name="submerchant_type" defaultValue={profile?.submerchant_type || 'bireysel'} className="px-4 py-3 border border-gray-100 rounded-xl bg-gray-50 focus:bg-white transition-all outline-none">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input name="tckn" defaultValue={profile?.tckn || ''} placeholder="11 Haneli" maxLength={11} className="px-4 py-3 border border-gray-100 rounded-xl bg-gray-50 focus:bg-white transition-all outline-none" />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold uppercase text-gray-400 tracking-widest">Vergi No (Kurumsal)</label>
                <input name="vkn" defaultValue={profile?.vkn || ''} placeholder="10 Haneli" maxLength={10} className="px-4 py-3 border border-gray-100 rounded-xl bg-gray-50 focus:bg-white transition-all outline-none" />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold uppercase text-gray-400 tracking-widest">Firma Ünvanı (Kurumsal)</label>
                <input name="company_title" defaultValue={profile?.company_title || ''} placeholder="Tam Şirket Ünvanı" className="px-4 py-3 border border-gray-100 rounded-xl bg-gray-50 focus:bg-white transition-all outline-none" />
              </div>
            </div>
          </div>
