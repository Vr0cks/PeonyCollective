    ...
    return (
      <main className="min-h-screen bg-white py-24 px-6">
        <div className="max-w-[800px] mx-auto prose prose-sm sm:prose-base prose-zinc">
          <h1 className="text-4xl serif-display mb-8">Terms of Use</h1>
          <p className="text-xs text-gray-500 uppercase tracking-widest mb-12">Last Updated: June 27, 2026</p>

          <h2>1. Parties and Scope</h2>
          <p>These Terms of Use govern the legal relationship between Peony Collective ("Platform") and Buyers and Sellers using the Platform. By accessing the platform, you agree to these terms.</p>

          <h2>2. Description of Service</h2>
          <p>Peony Collective is a luxury marketplace mediating the buying and selling of pre-owned luxury goods subject to lab authentication (appraisal). Peony Collective acts as a mediator between sellers and buyers except in VIP Concierge cases.</p>

          <h2>3. Authenticity and Peony Lab Guarantee</h2>
          <p>Every item sold through the Platform undergoes a 32-point physical inspection and 3D Spectral Analysis by Peony Lab. Unverified items are rejected and returned to the seller. Peony Collective offers a lifetime authenticity guarantee for every approved item.</p>

          <h2>4. Sales and Commission</h2>
          <p>Sellers agree to established commission rates when listing products on the Platform. Commission is deducted after successful delivery to the buyer, and net payout is transferred to the seller's designated IBAN account.</p>

          <h2>5. Cancellations and Returns</h2>
          <p>Buyers may exercise their right of withdrawal within 14 days of receipt. Returns are only valid provided the attached Peony Lock security seal remains intact and undamaged.</p>
