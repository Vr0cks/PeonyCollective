      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 h-20 flex items-center justify-between relative">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden lg:flex items-center gap-8 text-[11px] font-bold uppercase tracking-[0.2em] text-[#1A1A1A] ml-6">
            <Link href="/how-it-works" className="hover:text-[#AF9164] transition-colors duration-300">
            ...
            <div className="flex items-center gap-6 lg:gap-8">
              ...
              <Link href="/settings" className="flex items-center gap-4 group" title="Hesap Ayarlarım">
                <div className="text-right hidden sm:block">
                  <p className="text-[10px] font-bold uppercase tracking-[0.2em] leading-none mb-1.5 text-[#1A1A1A]">{t('nav.myAccount', 'HESABIM')}</p>
