        ...
        headers: [
          ...
          // PayTR iframe, Supabase storage ve Google Fonts'a izin verildi
          {
            ...
            value: [
              ...
              "frame-src 'self' https://www.paytr.com https://*.paytr.com https://*.bkm.com.tr https://*.bkmexpress.com.tr https: http:",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.tryoto.com https://www.paytr.com https://api.entrupy.com https://api.telegram.org https://api.resend.com https://ipapi.co https://api.open-meteo.com https://images.unsplash.com https://plus.unsplash.com https://api.bigdatacloud.net https://nominatim.openstreetmap.org",
              "media-src 'self' https://*.supabase.co",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self' https://www.paytr.com https://*.paytr.com https://*.bkm.com.tr https: http:",
            ].join('; '),
          },
        ],
      },
